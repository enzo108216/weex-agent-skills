...
- Use `buy_volume` and `sell_volume` to spot one-sided execution or heavy churn.
...
- If spot protective-order state is unavailable, keep the result explicit about that degraded boundary.

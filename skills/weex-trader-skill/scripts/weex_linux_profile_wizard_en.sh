...
PROMPT_SPOT_BASE_URL='4. Spot Base URL (optional): '
PROMPT_SET_DEFAULT='5. Set this profile as default? [y/N]: '
MSG_SECRET_NOTICE_1='6. API Key, Secret Key, and Passphrase will be requested next.'
